...
}},initialize:function($super,B,A,C){this.interactionParameters=Object.extend({displayProgressMessage:true,progressMessageText:"Sending request...",displaySuccessMessage:true,successMessageText:"Done!",displayFailureMessage:true,failureMessageText:"Failed: "},C||{});
this.requestUrl=B;
