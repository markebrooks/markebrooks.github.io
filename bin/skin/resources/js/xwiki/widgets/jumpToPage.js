...
$super(A);
if(typeof (XWiki.widgets.Suggest)!="undefined"){new XWiki.widgets.Suggest(this.input,{script:"/rest/wikis/xwiki/search?scope=name&number=10&media=json&",varname:"q",noresults:"No documents found",icon:"/resources/icons/silk/page_white_text.gif",json:true,resultsParameter:"searchResults",resultId:"id",resultValue:"pageFullName",resultInfo:"pageFullName",timeout:30000,parentContainer:this.dialog})
