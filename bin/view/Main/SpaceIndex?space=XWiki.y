...
<div class="rightmenu">
      <div class="topmenuentry " id="tmLogin"><a class="tme" href="https://auth.opensolaris.org/login.action?targetUrl=http%3A%2F%2Fmarkebrooks.github.io%2Fbin%2Fview%2FMain%2FSpaceIndex%3Fspace%3DXWiki.y"><strong>Log-in</strong></a></div>
  </div>
<div class="leftmenu">
...
<div id="xwikicontent">
<p>&nbsp;Pages in the XWiki.y space:</p><div class="wikimodel-emptyline"></div>                                                                                                                                 
  ...
  //
      var ta = new XWiki.widgets.LiveTable("/bin/view/XWiki/LiveTableResults?xpage=plain&outputSyntax=plain&transprefix=xe.index.&classname=&collist=doc.name,doc.date,doc.author&space=XWiki.y", "spaceindex", function (row, i, table) {
