...
<div class="minwidthb"></div>
    ...
    <div style="text-align:right;">
        <a class="glink" href="http://auth.opensolaris.org/login.action?targetUrl=http%3A%2F%2Fmarkebrooks.github.io%2Fbin%2Fview%2FMain%2FSpaceIndex%3Fspace%3DXWiki.w" id="headerlogin">Log-in</a><span class="separator"> | </span>
...
<p>&nbsp;Pages in the XWiki.w space:</p><div class="wikimodel-emptyline"></div>                                                                                                                                 
  ...
  //
      var ta = new XWiki.widgets.LiveTable("/bin/view/XWiki/LiveTableResults?xpage=plain&outputSyntax=plain&transprefix=xe.index.&classname=&collist=doc.name,doc.date,doc.author&space=XWiki.w", "spaceindex", function (row, i, table) {
